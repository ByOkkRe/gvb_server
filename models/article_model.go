...
type ArticleModel struct {
	...
	TagModels      []TagModel     `json:"tag_models" gorm:"many2many:article_tag_model"` //文章标签
	CommentsModels []CommentModel `json:"-" gorm:"foreignkey:ArticleID"`                 //文章的评论列表
	UserModel      UserModel      `json:"-" gorm:"foreignkey:UserID"`                    //文章作者
	UserID         uint           `json:"user_id"`                                       //用户ID
	Category       string         `json:"category" gorm:"size:32"`                       //文章分类
